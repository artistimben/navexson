...
(2, 'Mersin Uluslararası Limanı (MIP) Genişleme Projesi ve Liman Duyuruları', 'mersin-uluslararasi-limani-genisleme-projesi', 'Liman Duyuruları', '/images/news_limits.jpg', 'MIP rıhtımlarında yeni operasyonel kapasite ve yanaşma limitleri açıklandı.', 'Mersin Uluslararası Limanı (MIP) rıhtım genişletme çalışmaları kapsamında yeni yanaşma limitleri yürürlüğe girmiştir. Yük gemilerinizin yanaşma ve operasyon planlamalarında güncel liman cetvellerine dikkat edilmesi rica olunur.', 'NAVEXMAR Operasyon Masası', 1, NOW(), NOW(), NOW()),
